...
def info():
    ...
    if INFO_CHAT_ID and sub_id_10 and sub_id_11 and sub_id_12 and sub_id_13 and sub_id_14 and sub_id_15 and subid and status:
        database.create_request(sub_id_10,
                       ...
                       revenue)
        async def send():
            await bot.send_message(INFO_CHAT_ID, f"""<b>Пользователь</b> : {sub_id_10}
